...
Original file is located at
    https://colab.research.google.com/drive/120cHV1CBmBW9Vx6BnhFSek_-vcBn7iMM
...
def degrees_of_freedom(origin_metrics, varian_metrics):
  ...
  numerator = (np.square(s1) / n1 + np.square(s2) / n2) ** 2
  denominator = (np.square(s1)/n1)**2 / (n1 - 1) + (np.square(s2)/n2)**2 /(n2 - 1)
