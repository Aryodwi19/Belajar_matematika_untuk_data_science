# -*- coding: utf-8 -*-
"""Salinan dari soal-3-software-dev-ab.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1BuqFB9R40MbHuArbz_b76kZCRtyDvhoN
...
def estimate_sample_size_proportions(p1, p2, alpha=0.05, beta=0.20, two_sided=True):
    ...
    numerator = (np.sqrt(p_bar * q_bar * (1 + (1 / k))) * z_alpha + np.sqrt(p1 * q1 + (p2 * q2 / k)) * z_beta) ** 2
    n = numerator / (delta**2)
    # AKHIRI KODE DI SINI
